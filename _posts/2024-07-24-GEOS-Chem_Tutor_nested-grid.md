...
GEOS-Chem 에서 nested-grid 사용시 추천되는 해상도에 따른 영역의 범위는 [여기](https://wiki.seas.harvard.edu/geos-chem/index.php/FlexGrid#0.5.C2.B0_x_0.625.C2.B0_nested_Asia)를 참고하길 바란다. 이번 메뉴얼에서는 한반도가 포함된 영역을 사용할 것이며, 영역은 아래 그림과 같다. < 그림 [출처](https://wiki.seas.harvard.edu/geos-chem/index.php/GEOS-Chem_horizontal_grids#0.5_x_0.625_AS_nested_grid) >
