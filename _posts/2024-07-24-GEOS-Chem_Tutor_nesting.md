...
& 심창섭 (한국환경연구원, KEI)<br/>& 서정빈 (한국환경연구원, KEI)<br/>2024년 7월 25일</p>
...
이번 메뉴얼에서는 GEOS-Chem nested-grid 옵션을 사용하여 모델을 모의하는 방법을 정리하였다. GEOS-Chem nested-grid 옵션에 대한 자세한 내용을 알고 싶다면 [GEOS-Chem doc](https://geos-chem.readthedocs.io/en/stable/supplemental-guides/nested-grid-guide.html)와 [GEOS-Chem wiki](https://wiki.seas.harvard.edu/geos-chem/index.php/Setting_up_GEOS-Chem_nested_grid_simulations)를 참조하길 바란다. <br/>
기본적인 GEOS-Chem 모의는 이전 게시글에 정리하였으므로, [여기](https://swdo1312.github.io/GEOS-Chem_Tutor/)를 참조. 
